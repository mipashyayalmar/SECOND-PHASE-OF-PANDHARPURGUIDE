...
ALLOWED_HOSTS = [
    'f91b-103-200-214-111.ngrok-free.app',  # The exact ngrok URL you're using
    'localhost',
    '127.0.0.1',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'myapp.context_processors.advertisements',
                'django.template.context_processors.debug',
                'django.template.context_processors.request',
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
                'user.context_processors.social_data_processor',
            ],
        },
    },
]
